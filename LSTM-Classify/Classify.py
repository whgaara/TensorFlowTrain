...
class VOC_LSTM():
        ...
        with tf.Graph().as_default():
            ...
            with tf.Session() as sess:
                ...
                for epoch in range(VOC_LSTM.epoch_count):
                    ...
                    print(acc)
                    print(sess.run(prediction, feed_dict={x: test_batch_word2vec}))
    ...
    def use_model(self, discrete_content):
        ...
        with tf.Session() as sess:
            ...
            f = sess.run('rnn/while/Exit_4:0', feed_dict={'x:0': word2nums})
...
if __name__ == '__main__':
    ...
    # lc.record_info()
    # lc.lstm_model()
    # lc.use_model(['轻薄', '买 有点 大 '])
    lc.use_model(['天 到 ','买 有点 大 ','破 裤子 还 不能 处理','合适','码 正好 ','天 就 到 ','腰围 裤 长 穿 很 合适 ','鞋 非常 合适 ','多 性价比 非常 很 高 ','码 合适 裤子 有 弹性','赞 ','脚 码 正好 ','活动 也 给力 '])